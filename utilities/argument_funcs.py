...
version = "2025_1_VMM_contrastive_11_MuVi-Sync_best"
split_ver = SPLIT_VER
...
def parse_train_args():
    ...
    parser.add_argument("--is_contrastive_loss",type=bool,default=False)
    parser.add_argument("--is_mamba",type=bool,default=False)
    parser.add_argument("--is_mixer_mamba", type=bool, default=False)
    parser.add_argument("--is_pop909",type=bool,default=False)
...
def parse_generate_args():
    parser = argparse.ArgumentParser()
    outputpath = "./output_VMM/"+"2025_1_VMM_contrastive_11_MuVi-Sync_best_predictMuVi-Sync"
    if IS_VIDEO:
        modelpath = f"./saved_models/{version}/best_loss_weights.pickle"
    ...
    parser.add_argument("--is_datasetmidi",type=bool,default=False)
    parser.add_argument("--is_pop909", type=bool, default=False)
    parser.add_argument("--is_mixer_mamba",type=bool,default=False)
    parser.add_argument("-dataset_dir", type=str, default="./dataset/", help="Folder of VEVO dataset")
    
    parser.add_argument("-input_dir_music", type=str, default="./dataset/dataset/vevo_chord/" + MUSIC_TYPE, help="Folder of video CNN feature files")
    parser.add_argument("-input_dir_video", type=str, default="./dataset/dataset/vevo_vis", help="Folder of video CNN feature files")
